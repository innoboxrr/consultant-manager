<template>
	...
	<data-table
		title="ConsultationAdvice" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationAdviceExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-advice/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-advice' 
	...
	export default {
		...
		computed: {
			...
			consultationAdviceExternalFilters() {
