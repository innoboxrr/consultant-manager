<template>
	...
	<data-table
		title="ConsultantAvailability" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultantAvailabilityExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultant-availability/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultant-availability' 
	...
	export default {
		...
		computed: {
			...
			consultantAvailabilityExternalFilters() {
