                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consultationAppointmentAttendee.id },
                        },
                        label: 'Mostrar',
                    },
                    {
                    ...
                    {
                        type: 'event',
                        action: deleteConsultationAppointmentAttendee,
                        label: 'Eliminar',
                    },
                ]"
            />
...
<script>
import { deleteModel } from '@consultantManagerModels/consultation-appointment-attendee';
export default {
    props: {
    ...
    methods: {
        deleteConsultationAppointmentAttendee() {
            deleteModel(this.consultationAppointmentAttendee).then(() => {
                this.$router.push({ name: 'AdminConsultationAppointmentAttendees' });
            });
        }
    }
}
