...
<script>
    ...
    import { showModel, updateModel} from '@consultantManagerModels/consultation-appointment-attendee'
...
//register_more_components//
        ...
        props: {
            formId: {
                type: String,
                default: 'editConsultationAppointmentAttendeeForm'
            },
        ...
        methods: {
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    this.disabled = true;
                    updateModel(this.consultationAppointmentAttendee.id, {
//submit_data//
                    }).then( res => {
