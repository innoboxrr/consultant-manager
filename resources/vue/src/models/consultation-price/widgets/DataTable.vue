<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="consultationPriceExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-price/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-price' 
	...
	export default {
		...
		computed: {
			...
			consultationPriceExternalFilters() {
