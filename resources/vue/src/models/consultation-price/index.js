...
export const API_ROUTE_PREFIX = 'api.innoboxrr.consultant.manager.consultation_price.'; // Reemplaza con la ruta adecuada
	...
	return [
		{
			id: 'create',
			name: 'Create',
			callback: 'createConsultationPrice',
			icon: 'fa-plus',
			route: true,
			policy: false,
			params: {
