<template>
	...
	<data-table
		title="ConsultationIntakeForm" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationIntakeFormExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-intake-form/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-intake-form' 
	...
	export default {
		...
		computed: {
			...
			consultationIntakeFormExternalFilters() {
