<template>
	...
	<data-table
		title="ConsultationAppointment" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationAppointmentExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-appointment/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-appointment' 
	...
	export default {
		...
		computed: {
			...
			consultationAppointmentExternalFilters() {
