<template>
	<div id="AdminConsulteeRecordItemsWrapper">
...
<script>
	import DataTable from '@consultantManagerModels/consultee-record-item/widgets/DataTable.vue'
	...
	export default {
		...
		computed: {
			isHome() {
				return (this.$route.name == 'AdminConsulteeRecordItems');
			},
			hideColumns() {
				if(false) {
