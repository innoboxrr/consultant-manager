...
<script>
    ...
    import { showModel, updateModel} from '@consultantManagerModels/consultee-record-item'
...
//register_more_components//
        ...
        props: {
            formId: {
                type: String,
                default: 'editConsulteeRecordItemForm'
            },
        ...
        methods: {
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    this.disabled = true;
                    updateModel(this.consulteeRecordItem.id, {
//submit_data//
                    }).then( res => {
