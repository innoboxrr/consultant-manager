<template>
	...
	<data-table
		title="ConsulteeRecordItem" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consulteeRecordItemExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultee-record-item/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultee-record-item' 
	...
	export default {
		...
		computed: {
			...
			consulteeRecordItemExternalFilters() {
