                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consulteeRecordItem.id },
                        },
                        label: 'Mostrar',
                    },
                    {
                    ...
                    {
                        type: 'event',
                        action: deleteConsulteeRecordItem,
                        label: 'Eliminar',
                    },
                ]"
            />
...
<script>
import { deleteModel } from '@consultantManagerModels/consultee-record-item';
export default {
    props: {
        consulteeRecordItem: {
            type: Object,
    ...
    methods: {
        deleteConsulteeRecordItem() {
            deleteModel(this.consulteeRecordItem).then(() => {
                this.$router.push({ name: 'AdminConsulteeRecordItems' });
            });
        }
    }
}
