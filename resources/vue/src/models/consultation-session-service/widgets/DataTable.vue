<template>
	...
	<data-table
		title="ConsultationSessionService" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationSessionServiceExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-session-service/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-session-service' 
	...
	export default {
		...
		computed: {
			...
			consultationSessionServiceExternalFilters() {
