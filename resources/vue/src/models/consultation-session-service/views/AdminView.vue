<template>
	<div id="AdminConsultationSessionServicesWrapper">
...
<script>
	import DataTable from '@consultantManagerModels/consultation-session-service/widgets/DataTable.vue'
	...
	export default {
		...
		computed: {
			isHome() {
				return (this.$route.name == 'AdminConsultationSessionServices');
			},
			hideColumns() {
				if(false) {
