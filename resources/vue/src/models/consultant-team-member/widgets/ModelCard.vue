                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consultantTeamMember.id },
                        },
                        label: 'Mostrar',
                    },
                    {
                    ...
                    {
                        type: 'event',
                        action: deleteConsultantTeamMember,
                        label: 'Eliminar',
                    },
                ]"
            />
...
<script>
import { deleteModel } from '@consultantManagerModels/consultant-team-member';
export default {
    props: {
    ...
    methods: {
        deleteConsultantTeamMember() {
            deleteModel(this.consultantTeamMember).then(() => {
                this.$router.push({ name: 'AdminConsultantTeamMembers' });
            });
        }
    }
}
