<template>
	...
	<data-table
		title="ConsultantTeamMember" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultantTeamMemberExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultant-team-member/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultant-team-member' 
	...
	export default {
		...
		computed: {
			...
			consultantTeamMemberExternalFilters() {
