<template>
	...
	<data-table
		title="ConsulteeRecordResponse" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consulteeRecordResponseExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultee-record-response/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultee-record-response' 
	...
	export default {
		...
		computed: {
			...
			consulteeRecordResponseExternalFilters() {
