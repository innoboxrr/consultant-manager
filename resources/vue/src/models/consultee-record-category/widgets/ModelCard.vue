                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consulteeRecordCategory.id },
                        },
                        label: 'Mostrar',
                    },
                    {
                    ...
                    {
                        type: 'event',
                        action: deleteConsulteeRecordCategory,
                        label: 'Eliminar',
                    },
                ]"
            />
...
<script>
import { deleteModel } from '@consultantManagerModels/consultee-record-category';
export default {
    props: {
    ...
    methods: {
        deleteConsulteeRecordCategory() {
            deleteModel(this.consulteeRecordCategory).then(() => {
                this.$router.push({ name: 'AdminConsulteeRecordCategories' });
            });
        }
    }
}
