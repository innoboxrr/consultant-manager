<template>
	...
	<data-table
		title="ConsulteeRecordCategory" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consulteeRecordCategoryExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultee-record-category/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultee-record-category' 
	...
	export default {
		...
		computed: {
			...
			consulteeRecordCategoryExternalFilters() {
