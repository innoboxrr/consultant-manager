...
<script>
    ...
    import { showModel, updateModel} from '@consultantManagerModels/consultee-record-category'
...
//register_more_components//
        ...
        props: {
            formId: {
                type: String,
                default: 'editConsulteeRecordCategoryForm'
            },
        ...
        methods: {
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    this.disabled = true;
                    updateModel(this.consulteeRecordCategory.id, {
//submit_data//
                    }).then( res => {
