<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="consultantExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultant/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultant' 
