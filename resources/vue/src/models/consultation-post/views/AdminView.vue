<template>
	<div id="AdminConsultationPostsWrapper">
...
<script>
	import DataTable from '@consultantManagerModels/consultation-post/widgets/DataTable.vue'
	...
	export default {
		...
		computed: {
			isHome() {
				return (this.$route.name == 'AdminConsultationPosts');
			},
			hideColumns() {
				if(false) {
