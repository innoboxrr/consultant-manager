...
<script>
import { deleteModel } from '@consultantManagerModels/consultation-post';
export default {
    props: {
        consultationPost: {
            type: Object,
    ...
    methods: {
        deleteConsultationPost() {
            deleteModel(this.consultationPost).then(() => {
                this.$router.push({ name: 'AdminConsultationPosts' });
            });
        }
    }
}
