<template>
	...
	<data-table
		title="ConsultationPost" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationPostExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-post/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-post' 
	...
	export default {
		...
		computed: {
			...
			consultationPostExternalFilters() {
