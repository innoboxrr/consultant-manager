...
export const API_ROUTE_PREFIX = 'api.innoboxrr.consultant.manager.consultation_post.'; // Reemplaza con la ruta adecuada
	...
	return [
		{
			id: 'create',
			name: 'Create',
			callback: 'createConsultationPost',
			icon: 'fa-plus',
			route: true,
			policy: false,
			params: {
