<template>
	...
	<data-table
		title="ConsultantRecordTemplate" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultantRecordTemplateExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultant-record-template/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultant-record-template' 
	...
	export default {
		...
		computed: {
			...
			consultantRecordTemplateExternalFilters() {
