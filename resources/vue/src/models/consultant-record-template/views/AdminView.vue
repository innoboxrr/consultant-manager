<template>
	<div id="AdminConsultantRecordTemplatesWrapper">
...
<script>
	import DataTable from '@consultantManagerModels/consultant-record-template/widgets/DataTable.vue'
	...
	export default {
		...
		computed: {
			isHome() {
				return (this.$route.name == 'AdminConsultantRecordTemplates');
			},
			hideColumns() {
				if(false) {
