<template>
	...
	<data-table
		title="ConsulteeRecord" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consulteeRecordExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultee-record/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultee-record' 
	...
	export default {
		...
		computed: {
			...
			consulteeRecordExternalFilters() {
