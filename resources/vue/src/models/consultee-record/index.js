...
export const API_ROUTE_PREFIX = 'api.innoboxrr.consultant.manager.consultee_record.'; // Reemplaza con la ruta adecuada
	...
	return [
		{
			id: 'create',
			name: 'Create',
			callback: 'createConsulteeRecord',
			icon: 'fa-plus',
			route: true,
			policy: false,
			params: {
