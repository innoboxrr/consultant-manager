<template>
	...
	<data-table
		title="ConsultationSession" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationSessionExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-session/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-session' 
	...
	export default {
		...
		computed: {
			...
			consultationSessionExternalFilters() {
