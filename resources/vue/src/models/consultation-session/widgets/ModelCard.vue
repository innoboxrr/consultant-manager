                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consultationSession.id },
                        },
                        label: 'Mostrar',
                    },
                    {
...
<script>
import { deleteModel } from '@consultantManagerModels/consultation-session';
export default {
    props: {
        consultationSession: {
            type: Object,
    ...
    created() {
        if (!this.consultationSession && !this.consultationSessionId) {
            console.error("Se debe proporcionar 'consultationSession' o 'consultationSessionId'.");
        }
    },
    methods: {
        deleteConsultationSession() {
            deleteModel(this.consultationSession).then(() => {
                this.$router.push({ name: 'AdminConsultationSessions' });
            });
        }
    }
}
