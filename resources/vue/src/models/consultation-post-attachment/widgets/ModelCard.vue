                ...
                :items="[
                    {
                        ...
                        to: {
                            ...
                            params: { id: consultationPostAttachment.id },
                        },
                        label: 'Mostrar',
                    },
                    {
                    ...
                    {
                        type: 'event',
                        action: deleteConsultationPostAttachment,
                        label: 'Eliminar',
                    },
                ]"
            />
...
<script>
import { deleteModel } from '@consultantManagerModels/consultation-post-attachment';
export default {
    props: {
    ...
    methods: {
        deleteConsultationPostAttachment() {
            deleteModel(this.consultationPostAttachment).then(() => {
                this.$router.push({ name: 'AdminConsultationPostAttachments' });
            });
        }
    }
}
