<template>
	...
	<data-table
		title="ConsultationPostAttachment" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationPostAttachmentExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-post-attachment/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-post-attachment' 
	...
	export default {
		...
		computed: {
			...
			consultationPostAttachmentExternalFilters() {
