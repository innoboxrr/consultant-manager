...
<script>
    ...
    import { showModel, updateModel} from '@consultantManagerModels/consultation-post-attachment'
...
//register_more_components//
        ...
        props: {
            formId: {
                type: String,
                default: 'editConsultationPostAttachmentForm'
            },
        ...
        methods: {
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    this.disabled = true;
                    updateModel(this.consultationPostAttachment.id, {
//submit_data//
                    }).then( res => {
