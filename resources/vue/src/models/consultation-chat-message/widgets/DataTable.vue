<template>
	...
	<data-table
		title="ConsultationChatMessage" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationChatMessageExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-chat-message/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-chat-message' 
	...
	export default {
		...
		computed: {
			...
			consultationChatMessageExternalFilters() {
