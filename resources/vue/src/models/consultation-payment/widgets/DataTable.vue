<template>
	...
	<data-table
		title="ConsultationPayment" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationPaymentExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-payment/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-payment' 
	...
	export default {
		...
		computed: {
			...
			consultationPaymentExternalFilters() {
