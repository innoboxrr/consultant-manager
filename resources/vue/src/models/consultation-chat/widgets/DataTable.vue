<template>
	...
	<data-table
		title="ConsultationChat" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationChatExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-chat/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-chat' 
	...
	export default {
		...
		computed: {
			...
			consultationChatExternalFilters() {
