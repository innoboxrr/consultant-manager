...
export const API_ROUTE_PREFIX = 'api.innoboxrr.consultant.manager.consultation_chat.'; // Reemplaza con la ruta adecuada
	...
	return [
		{
			id: 'create',
			name: 'Create',
			callback: 'createConsultationChat',
			icon: 'fa-plus',
			route: true,
			policy: false,
			params: {
