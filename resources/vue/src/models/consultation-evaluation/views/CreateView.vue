<template>
	<div>
		<breadcrumbs-component  
			:pages="[
				{ link: $router.resolve({ name: 'AdminConsultationEvaluations' }).fullPath, title: 'ConsultationEvaluations'},
				{ link: $router.resolve({ name: 'AdminCreateConsultationEvaluation' }).fullPath, title: 'Crear ConsultationEvaluations'}
			]"/>	
...
<script>
	...
	import CreateForm from '@consultantManagerModels/consultation-evaluation/forms/CreateForm.vue'
