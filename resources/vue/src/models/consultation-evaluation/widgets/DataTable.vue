<template>
	...
	<data-table
		title="ConsultationEvaluation" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="consultationEvaluationExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultation-evaluation/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultation-evaluation' 
	...
	export default {
		...
		computed: {
			...
			consultationEvaluationExternalFilters() {
