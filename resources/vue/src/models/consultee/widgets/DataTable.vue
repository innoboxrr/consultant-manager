<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="consulteeExternalFilters"
...
<script>
	...
	import FilterForm from '@consultantManagerModels/consultee/forms/FilterForm.vue'
	import * as model from '@consultantManagerModels/consultee' 
