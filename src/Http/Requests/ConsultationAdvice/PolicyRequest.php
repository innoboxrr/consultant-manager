...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationAdvice,id',
    ...
    public function handle()
    {
         ...
         $consultationAdvice = ($this->id) ? 
            ConsultationAdvice::findOrFail($this->id) : 
            app(ConsultationAdvice::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationAdvice),
        ]);
