...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationChat,id',
    ...
    public function handle()
    {
         ...
         $consultationChat = ($this->id) ? 
            ConsultationChat::findOrFail($this->id) : 
            app(ConsultationChat::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationChat),
        ]);
