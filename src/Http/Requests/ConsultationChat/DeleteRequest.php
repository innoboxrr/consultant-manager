...
use Innoboxrr\ConsultantManager\Http\Events\ConsultationChat\Events\DeleteEvent;
...
class DeleteRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        return $this->user()->can('delete', $consultationChat);
    ...
    public function handle()
    {
        ...
        $consultationChat->deleteModel();

        $response = new ConsultationChatResource($consultationChat);

        event(new DeleteEvent($consultationChat, $this->all(), $response));
