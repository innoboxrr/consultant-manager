...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationPayment,id',
    ...
    public function handle()
    {
         ...
         $consultationPayment = ($this->id) ? 
            ConsultationPayment::findOrFail($this->id) : 
            app(ConsultationPayment::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationPayment),
        ]);
