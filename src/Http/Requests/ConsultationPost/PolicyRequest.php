...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationPost,id',
    ...
    public function handle()
    {
         ...
         $consultationPost = ($this->id) ? 
            ConsultationPost::findOrFail($this->id) : 
            app(ConsultationPost::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationPost),
        ]);
