...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultantAvailability,id',
    ...
    public function handle()
    {
         ...
         $consultantAvailability = ($this->id) ? 
            ConsultantAvailability::findOrFail($this->id) : 
            app(ConsultantAvailability::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultantAvailability),
        ]);
