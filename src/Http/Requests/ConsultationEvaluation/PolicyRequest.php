...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationEvaluation,id',
    ...
    public function handle()
    {
         ...
         $consultationEvaluation = ($this->id) ? 
            ConsultationEvaluation::findOrFail($this->id) : 
            app(ConsultationEvaluation::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationEvaluation),
        ]);
