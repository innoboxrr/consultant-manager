...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\ConsultantManager\Models\ConsultationSession,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? ConsultationSession::findOrFail($this->id) : app(ConsultationSession::class);
