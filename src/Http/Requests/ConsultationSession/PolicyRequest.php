...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultationSession,id',
    ...
    public function handle()
    {
         ...
         $consultationSession = ($this->id) ? 
            ConsultationSession::findOrFail($this->id) : 
            app(ConsultationSession::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultationSession),
        ]);
