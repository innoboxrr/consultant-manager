...
use Innoboxrr\ConsultantManager\Http\Events\ConsultationSessionService\Events\ForceDeleteEvent;
...
class ForceDeleteRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        return $this->user()->can('forceDelete', $consultationSessionService);
    ...
    public function handle()
    {
        ...
        $consultationSessionService->forceDeleteModel();

        $response = new ConsultationSessionServiceResource($consultationSessionService);

        event(new ForceDeleteEvent($consultationSessionService, $this->all(), $response));
