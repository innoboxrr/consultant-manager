...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsulteeRecordCategory,id',
    ...
    public function handle()
    {
         ...
         $consulteeRecordCategory = ($this->id) ? 
            ConsulteeRecordCategory::findOrFail($this->id) : 
            app(ConsulteeRecordCategory::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consulteeRecordCategory),
        ]);
