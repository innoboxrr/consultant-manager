...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\ConsultantManager\Models\ConsultantRecordTemplate,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? ConsultantRecordTemplate::findOrFail($this->id) : app(ConsultantRecordTemplate::class);
