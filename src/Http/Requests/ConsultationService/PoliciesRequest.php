...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\ConsultantManager\Models\ConsultationService,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? ConsultationService::findOrFail($this->id) : app(ConsultationService::class);
