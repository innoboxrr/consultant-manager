...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\ConsultantManager\Models\ConsultantTeamMember,id',
    ...
    public function handle()
    {
         ...
         $consultantTeamMember = ($this->id) ? 
            ConsultantTeamMember::findOrFail($this->id) : 
            app(ConsultantTeamMember::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $consultantTeamMember),
        ]);
