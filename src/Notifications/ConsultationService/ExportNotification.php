...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationService;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationServicesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationServicesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationService export notification';
    }
