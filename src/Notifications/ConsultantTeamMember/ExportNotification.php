...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultantTeamMember;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultantTeamMembersExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultantTeamMembersExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultantTeamMember export notification';
    }
