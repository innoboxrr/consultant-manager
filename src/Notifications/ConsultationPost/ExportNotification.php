...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationPost;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationPostsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationPostsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationPost export notification';
    }
