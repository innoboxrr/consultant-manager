...
namespace Innoboxrr\ConsultantManager\Notifications\Consultant;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultantsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultantsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | Consultant export notification';
    }
