...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationPrice;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationPricesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationPricesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationPrice export notification';
    }
