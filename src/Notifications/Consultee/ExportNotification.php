...
namespace Innoboxrr\ConsultantManager\Notifications\Consultee;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsulteesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsulteesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | Consultee export notification';
    }
