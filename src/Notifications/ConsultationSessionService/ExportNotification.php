...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationSessionService;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationSessionServicesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationSessionServicesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationSessionService export notification';
    }
