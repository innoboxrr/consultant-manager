...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationIntakeForm;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationIntakeFormsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationIntakeFormsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationIntakeForm export notification';
    }
