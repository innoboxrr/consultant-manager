...
namespace Innoboxrr\ConsultantManager\Notifications\ConsulteeRecordCategory;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsulteeRecordCategoriesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsulteeRecordCategoriesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsulteeRecordCategory export notification';
    }
