...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationAppointmentAttendee;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationAppointmentAttendeesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationAppointmentAttendeesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationAppointmentAttendee export notification';
    }
