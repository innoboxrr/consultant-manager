...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultantAvailability;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultantAvailabilitiesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultantAvailabilitiesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultantAvailability export notification';
    }
