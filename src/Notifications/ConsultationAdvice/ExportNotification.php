...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationAdvice;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationAdvicesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationAdvicesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationAdvice export notification';
    }
