...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationPostAttachment;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationPostAttachmentsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationPostAttachmentsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationPostAttachment export notification';
    }
