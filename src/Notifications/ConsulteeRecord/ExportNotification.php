...
namespace Innoboxrr\ConsultantManager\Notifications\ConsulteeRecord;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsulteeRecordsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsulteeRecordsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsulteeRecord export notification';
    }
