...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationSession;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationSessionsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationSessionsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationSession export notification';
    }
