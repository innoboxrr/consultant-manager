...
namespace Innoboxrr\ConsultantManager\Notifications\ConsulteeRecordResponse;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsulteeRecordResponsesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsulteeRecordResponsesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsulteeRecordResponse export notification';
    }
