...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultantRecordTemplate;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultantRecordTemplatesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultantRecordTemplatesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultantRecordTemplate export notification';
    }
