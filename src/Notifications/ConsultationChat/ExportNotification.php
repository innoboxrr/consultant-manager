...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationChat;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationChatsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationChatsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationChat export notification';
    }
