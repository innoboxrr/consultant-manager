...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationEvaluation;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationEvaluationsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationEvaluationsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationEvaluation export notification';
    }
