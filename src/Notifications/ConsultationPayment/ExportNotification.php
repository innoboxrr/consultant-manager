...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationPayment;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationPaymentsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        return env('APP_NAME') . ' | ConsultationPayment export notification';
    }
