...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationAppointment;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationAppointmentsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationAppointmentsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationAppointment export notification';
    }
