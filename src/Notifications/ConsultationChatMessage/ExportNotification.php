...
namespace Innoboxrr\ConsultantManager\Notifications\ConsultationChatMessage;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\ConsultantManager\Exports\ConsultationChatMessagesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new ConsultationChatMessagesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | ConsultationChatMessage export notification';
    }
